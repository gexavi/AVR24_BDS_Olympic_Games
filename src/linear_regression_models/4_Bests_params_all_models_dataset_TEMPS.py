...
## FUNCTION R2/MAE/MSE/RMSE SCORE
...
print("\nRIDGE MODEL")
print("===========")
ridge=Ridge(alpha=10,tol=0.0001)
# TRAIN MODEL
ridge.fit(X_train_loo,y_train)
# SCORE
print("R2 sur train :",ridge.score(X_train_loo,y_train))
print("R2 sur test :",ridge.score(X_test_loo,y_test))
#print("alpha :",ridge.alpha_)
#print("score :",ridge.best_score_)
# PREDICT
...
# SCORE
print("R2 sur train :",lasso.score(X_train_loo,y_train))
print("R2 sur test :",lasso.score(X_test_loo,y_test))
# PREDICT
...
print("\nELASTICNET MODEL")
print("================")
elastic=ElasticNet(alpha=0.01,l1_ratio=0.79999,max_iter=1000,tol=0.001)
# TRAIN MODEL
elastic.fit(X_train_loo,y_train)
# SCORE
print("R2 sur train :",elastic.score(X_train_loo,y_train))
print("R2 sur test :",elastic.score(X_test_loo,y_test))
...
resultdf.to_csv('debug/tempsfull_result_std_predict.csv',index=False)
coefs.to_csv('debug/tempsfull_result_std_coefs.csv',index=False)
scores_mdl.to_csv('debug/tempsfull_result_std_scores.csv',index=False)

with pd.ExcelWriter("debug/tempsfull_result_std.xlsx") as writer:
...
ax4.legend()
plt.savefig("debug/tempsfull_std_distrib_errors.png")
