...
## OPENING DATASETS
df=pd.read_csv('in/WA_temps_enrichie_20062024.csv')
dfv=pd.read_csv('in/WA_temps_validate_24062024_v2.csv')
dfv=dfv[['competition_name','event','rtype','rdate','name','gender','nationality','height','weight','age','annual_perf_nb','annual_perf_max','annual_perf_moy','or_perf']]
...
resultdf.to_csv("out/WA_temps_validate_prediction.csv")

#with pd.ExcelWriter("debug/temps_validate_result_std.xlsx") as writer:
